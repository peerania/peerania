...
struct achievement {
  ...
  std::map<uint32_t, achievement> achievements = {
    ...
    { FIRST_10K_REGISTERED,         achievement(0, 20, 1, LIMITED_EDITION, REGISTERED) },
    { LIMITED_NEWBIE,               achievement(0, 10, RATING_NEWBIE, LIMITED_EDITION, RATING) },
    { LIMITED_JUNIOR,               achievement(0, 5, RATING_JUNIOR, LIMITED_EDITION, RATING) },
    { LIMITED_RESIDENT,             achievement(0, 4, RATING_RESIDENT, LIMITED_EDITION, RATING) },
    { LIMITED_SENIOR,               achievement(0, 3, RATING_SENIOR, LIMITED_EDITION, RATING) },
    { LIMITED_HERO,                 achievement(0, 2, RATING_HERO, LIMITED_EDITION, RATING) },
    { LIMITED_SUPERHERO,            achievement(0, 1, RATING_SUPERHERO, LIMITED_EDITION, RATING) },
