...
#define DEBUG_PROPERTY_REWARD_TIME 111
#define DEBUG_PROPERTY_CURRENT_TIME 112
#define DEBUG_PROPERTY_REWARD_TIME_PASSED 113
#define DEBUG_ACCOUNT_STAT_RESET_PERIOD 114
