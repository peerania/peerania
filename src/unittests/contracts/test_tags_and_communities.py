...
class TagsAndCommunitiesTests(peeranhatest.peeranhaTest):
    ...
    def test_modify_question(self):
        ...
        for i in range(6):
            self.assertTrue(t[i]['questions_asked'] == pupularity1[i])
        self.action('modquestion', {'user': 'bob', 'question_id': var['bq'], 'community_id': 2, 'tags': [1, 3], 'title': 'Title bob question', 'ipfs_link': 'BQ', 'type': 0, 'restore_rating': True}, bob,
    ...
    def test_unique_tag_assert_failed(self):
        ...
        self.failed_action('modquestion', {'user': 'alice', 'question_id': var['aq'], 'community_id': 1, 'tags': [1, 3, 2, 1], 'title': 'Title alice question', 'ipfs_link': 'AQ', 'type': 0, 'restore_rating': True}, alice,
    ...
    def test_non_existing_tag_community_failed(self):
        ...
        self.assertTrue(compare([{'id': '#var aq',
                                  'user': 'alice'}], self.table('question', 'allquestions'), var, True))
        self.failed_action('modquestion', {'user': 'alice', 'question_id': var['aq'], 'community_id': 1, 'tags': [1, 9], 'title': 'Title alice question', 'ipfs_link': 'AQ', 'type': 0, 'restore_rating': True}, alice,
